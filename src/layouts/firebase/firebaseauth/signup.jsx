                  ...
                  <Card>
                    <Card.Body>
                      <div className="text-center mb-6">
                        <Link className="header-brand1" to='#'>
                          <img src={Imagesdata("logo")}
                            className="header-brand-img main-logo" alt="Zanex logo" />
                          <img src={Imagesdata("logo")}
                            className="header-brand-img darklogo" alt="Zanex logo" />
                        </Link>
                      </div>
                      <h3>Register</h3>
                      ...
                      <InputGroup className="input-group mb-3">
                        ...
                        <Form.Control type="text"  name="fullname" placeholder="User name" value={fullname}
                    ...
                    onChange={changeHandler} />
                      ...
                      <Form.Group className="form-group">
                        <Form.Label className="custom-control custom-checkbox text-start">
                          ...
                          <span className="custom-control-label">Agree the <Link to='#'>terms
                      ...
                      <Row>
                        <div>
                          <Button variant='primary' to="#" onClick={Signup} className="btn btn-block px-4">Create a
                            new account</Button>
                        </div>  
                        <div className="text-center pt-3">
            <p className="text-dark mb-0">Already have account?<Link to={`${import.meta.env.BASE_URL}firebaseauth/authlogin`} className="text-primary ms-1">Sign In</Link></p>
          </div>
                      </Row>
