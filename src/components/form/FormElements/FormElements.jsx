...
import { Tabs, Tab, OverlayTrigger, Tooltip, Breadcrumb, Card, Row, Col, Form, Button,} from "react-bootstrap";
import { Link } from "react-router-dom";
import {Selectdate,Dateofbirth,Selectyear,Country,InputSelect,BillingInformationCounrty} from '../../../commondata/selectdata';
import PageHeader from "../../../layouts/layoutcomponents/pageheader";
export default function FormElements() { return (
    <div>
          ...
          <Card>
            ...
            <div className="card-body pt-2">
              ...
              <div className="form-group m-0">
                ...
                <Row>
                  <div className="col-md-5 col-xs-12 mb-2">
                    <Selectdate />
                  </div>
      ...
      <Row>
        <div className="col-lg-12 col-xl-12 col-md-12 col-sm-12">
          <Card>
            <Card.Header>
              <h4 className="card-title">General Elements</h4>
            </Card.Header>
            <Card.Body>
              <Row>
                ...
                <div className="col-lg-6 col-md-12">
                  <form className="form-horizontal">
                    ...
                    <div className=" row mb-4">
                      ...
                      <div className="col-md-9">
                        <input className="form-control" type="number" name="tel" />
                      </div>
                    </div>
                    <div className=" row mb-4 mb-0">
