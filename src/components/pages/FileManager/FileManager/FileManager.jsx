...
import { Breadcrumb, Col, Row, Card, ListGroup, ProgressBar,} from "react-bootstrap";
import { Link } from "react-router-dom";
import {list1,Creatnewfile} from '../../../../commondata/commondata';
import PageHeader from "../../../../layouts/layoutcomponents/pageheader";

export default function FileManager() {
  return (
    <div>
             <PageHeader titles="File Manager" active="File Manager" items={['Pages']} />
      <Row className="row-sm">
        ...
        <Col md={7} lg={7} xl={9}>
          <Row className="row-sm">
            ...
            <Col xl={3} md={6} sm={6}>
              <Card className="pos-relative">
                <Link
                  to={`${import.meta.env.BASE_URL}pages/FileManager/FileManagerList/FileManagerList/`}
                  className="open-file"
                />
          ...
          <Row>
          {list1.map((lists)=>(
        <Col xl={3} xxl={3} lg={6} md={6} sm={6} key={Math.random()}>
